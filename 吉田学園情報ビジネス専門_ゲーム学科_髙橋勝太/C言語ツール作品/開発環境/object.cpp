...
HRESULT InitObject(void)
{
	...
	//D3DXLoadMeshFromX("%c", D3DXMESH_SYSTEMMEM, pDevice, NULL, &g_pBuffMatObject[0], NULL, &g_nNumMatObject, &g_pMeshObject[0]), g_XFailName;
...
bool CollisionVec(D3DXVECTOR3 *pPos, D3DXVECTOR3 *pPosOld, D3DXVECTOR3 *pMove, float fWidthMax, float fWidthMin, float fDepthMax, float fDepthMin, float fHeightMax, float fHeightMin)
{
	...
	for (int nCntObjectUse = 0; nCntObjectUse < MAX_OBJECT; nCntObjectUse++, pCar++)
	{
		//使用されているとき
