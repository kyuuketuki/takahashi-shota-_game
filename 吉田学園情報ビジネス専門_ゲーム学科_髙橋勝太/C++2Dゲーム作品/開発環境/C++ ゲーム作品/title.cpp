...
HRESULT CTitle::Init(D3DXVECTOR3 pos, float fSizeX, float fSizeY)
{
	...
	//オブジェクトの生成
	//CScene3D::Create(D3DXVECTOR3(-30.0f, 0.0f, 0.0f));
	...
	//Ｘファイルの読み込み
	//char *apTextName = "data/MODEL/頭.x";

	//m_apModel->CModel::Create(D3DXVECTOR3(0.0f, 0.0f, 0.0f),D3DXVECTOR3(0.0f, 0.0f, 0.0f), apTextName);
	
	////オブジェクトの生成
	//CObject3D::Create(D3DXVECTOR3(30.0f,0.0f,0.0f),D3DXVECTOR3(0.0f,0.0f,0.0f), 0);
	//CObject3D::Create(D3DXVECTOR3(-30.0f, 0.0f, 0.0f), D3DXVECTOR3(0.0f, 0.0f, 0.0f), 0);
