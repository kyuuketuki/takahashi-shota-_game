...
// Get関数 & 変数の値保存
//=============================================================================
int CManager::GetPlayerLife(void)
{
	return g_nPlayerLife;
}

void CManager::SetMaxPlayerLife(int nLife)
{
	g_nMaxPlayerLife = nLife;
}

int CManager::GetMaxPlayerLife(void)
{
	return g_nMaxPlayerLife;
}

void CManager::SetPlayerLife(int nLife)
{
	g_nPlayerLife = nLife;
}

void CManager::DamagePlayerLife(int nLife)
{
	g_nPlayerLife -= nLife;
}

void CManager::RecoveryPlayerLife(int nLife)
{
	g_nPlayerLife += nLife;
}

int CManager::GetPlayerType(void)
{
	return g_nPlayerType;
}

void CManager::SetPlayerType(int nType)
{
	g_nPlayerType = nType;
}

int CManager::GetEnemyDead(void)
{
	return g_EnemyDead;
}

void CManager::SetEnemyDead(int nData)
{
	g_EnemyDead = nData;
}

void CManager::AddEnemyDead(int nData)
{
	g_EnemyDead += nData;
}

int CManager::GetGameStage(void)
{
	return g_nGameStage;
}

void CManager::SetGameStage(int nData)
{
	g_nGameStage = nData;
}
...
bool CManager::GetGameClear(void)
{
	return g_bGameClear;
}

void CManager::SetGameClear(bool bData)
{
	g_bGameClear = bData;
}
