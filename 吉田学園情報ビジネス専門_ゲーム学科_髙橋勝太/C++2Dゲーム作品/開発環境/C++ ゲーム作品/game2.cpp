...
void CGame2::Update(void)
{
	...
	else
	{
		...
		if (nTimeGame2 == 1 && nTimeCounter2 == 0)
		{
			...
			CEnemy::Create(D3DXVECTOR3(0.0f, -300.0f, 0.0f), 8.0f, D3DXVECTOR3(SCREEN_WIDTH / 2 - 300, 400.0f, 0.0f), 3000, ENEMY_SIZE + 50, ENEMY_SIZE + 50, 1000, ENEMY_BOSS_02, 5);
			CEnemy::Create(D3DXVECTOR3(SCREEN_WIDTH, -300.0f, 0.0f), 8.0f, D3DXVECTOR3(SCREEN_WIDTH / 2 + 300, 400.0f, 0.0f), 3000, ENEMY_SIZE + 50, ENEMY_SIZE + 50, 1000, ENEMY_BOSS_03, 6);		
		}
...
void CGame2::Attack3(void)
{
	...
	if (nTimeGame2 == 3 && nTimeCounter2 == 0)
	{
		...
		{
			CBullet::InitAngleBullet2(D3DXVECTOR3(SCREEN_WIDTH / 2, 300.0f, 0.0f), 1.0f, D3DXCOLOR(0.0f, 1.0f, 0.0f, 1.0f), 2000, 0, BULLET_SIZE, BULLET_SIZE, 62.8 * nCnt, OBJTYPE_BULET_ENEMY, 1);
			CBullet::InitAngleBullet2(D3DXVECTOR3(SCREEN_WIDTH / 2, 300.0f, 0.0f), 2.0f, D3DXCOLOR(1.0f, 1.0f, 0.0f, 1.0f), 2000, 0, BULLET_SIZE, BULLET_SIZE, 62.8 * nCnt, OBJTYPE_BULET_ENEMY, 2);
			CBullet::InitAngleBullet2(D3DXVECTOR3(SCREEN_WIDTH / 2, 300.0f, 0.0f), 3.0f, D3DXCOLOR(1.0f, 1.0f, 0.0f, 1.0f), 2000, 0, BULLET_SIZE, BULLET_SIZE, 62.8 * nCnt, OBJTYPE_BULET_ENEMY, 2);
			CBullet::InitAngleBullet2(D3DXVECTOR3(SCREEN_WIDTH / 2, 300.0f, 0.0f), 4.0f, D3DXCOLOR(1.0f, 1.0f, 0.0f, 1.0f), 2000, 0, BULLET_SIZE, BULLET_SIZE, 62.8 * nCnt, OBJTYPE_BULET_ENEMY, 2);
		}
	}
