...
void CGame2::Update(void)
{
	...
	else
	{
		...
		{
			CEnemy::Create(D3DXVECTOR3(SCREEN_WIDTH / 2, -300.0f, 0.0f), 8.0f, D3DXVECTOR3(SCREEN_WIDTH / 2, 300.0f, 0.0f), 700, ENEMY_SIZE + 300, ENEMY_SIZE + 200, 1000, ENEMY_BOSS_01, 0);
			CEnemy::Create(D3DXVECTOR3(0.0f, -300.0f, 0.0f), 8.0f, D3DXVECTOR3(SCREEN_WIDTH / 2 - 300, 400.0f, 0.0f), 30, ENEMY_SIZE + 50, ENEMY_SIZE + 50, 1000, ENEMY_BOSS_02, 5);
			CEnemy::Create(D3DXVECTOR3(SCREEN_WIDTH, -300.0f, 0.0f), 8.0f, D3DXVECTOR3(SCREEN_WIDTH / 2 + 300, 400.0f, 0.0f), 30, ENEMY_SIZE + 50, ENEMY_SIZE + 50, 1000, ENEMY_BOSS_03, 6);		
		}
